...
[简体中文](README.md) | [繁體中文](README.zh-TW.md) | [English](README.en.md) | **日本語** | [Français](README.fr.md) | [Deutsch](README.de.md) | [Español](README.es.md) | [Português](README.pt.md) | [📋 Changelog](CHANGELOG.md)
...
| **Deno Deploy** | [→ セットアップガイド](deno-deploy/README.ja.md) | Deno エコシステムを好む |
...
4 段階フィルタリングロジック、Microsoft Defender SafeLinks スキャナ対策の仕組み、IP レンジ更新フロー、ローカル開発、ソースコード構成など → **[`docs/architecture.ja.md`](docs/architecture.ja.md)**
