# Email Tracking Domain (Implantação em um clique)

> Implante seu próprio proxy reverso de domínio de rastreamento de email em um clique. Ofereça rastreamento de aberturas/cliques sob seu próprio domínio e evite o dano de reputação dos domínios de rastreamento compartilhados.
