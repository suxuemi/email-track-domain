...
**Language**: [简体中文](architecture.md) · [繁體中文](architecture.zh-TW.md) · [English](architecture.en.md) · [日本語](architecture.ja.md) · **Français** · [Deutsch](architecture.de.md) · [Español](architecture.es.md) · [Português](architecture.pt.md)

> Ce document s'adresse aux développeurs / curieux techniques. Si vous voulez juste déployer, suivez les « Trois étapes » dans le [README](../README.fr.md) principal.
...
├── README.md                          # README principal (allégé)
└── LICENSE                            # MIT
```
