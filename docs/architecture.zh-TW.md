...
**Language**: [简体中文](architecture.md) · **繁體中文** · [English](architecture.en.md) · [日本語](architecture.ja.md) · [Français](architecture.fr.md) · [Deutsch](architecture.de.md) · [Español](architecture.es.md) · [Português](architecture.pt.md)

> 本文件面向開發者 / 技術好奇者。如果你只想部署使用,看主 [README](../README.zh-TW.md) 的「3 步搞定」即可。
