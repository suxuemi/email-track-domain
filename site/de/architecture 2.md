...
> Dieses Dokument richtet sich an Entwickler / technisch Interessierte. Wenn Sie nur deployen möchten, folgen Sie den „Drei Schritten" in der Haupt-[README](../quick-start.md).
...
├── quick-start.md                          # Haupt-README (schlank)
└── LICENSE                            # MIT
```
