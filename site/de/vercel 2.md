...
Den Button finden Sie im Repo-Root [quick-start.md](../quick-start.md).
...
Nach dem Deployment in Vercel Dashboard → Project → Settings → Domains die Domain hinzufügen und gemäß Anweisung beim DNS-Anbieter einen CNAME `track → cname.vercel-dns.com` setzen. Details siehe [custom-domain.md](../custom-domain.md).
