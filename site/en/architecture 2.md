...
> This document is for developers / the technically curious. If you just want to deploy, follow the "Three steps" in the main [README](../quick-start.md).
...
├── quick-start.md                          # Main README (slim)
└── LICENSE                            # MIT
```
