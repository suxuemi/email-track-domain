...
See the button at the repo root [quick-start.md](../quick-start.md).
...
After deployment, go to Vercel Dashboard → Project → Settings → Domains, add your domain, and follow the instructions to add a CNAME `track → cname.vercel-dns.com` at your DNS provider. See [custom-domain.md](../custom-domain.md).
