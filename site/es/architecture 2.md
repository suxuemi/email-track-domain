...
> Este documento es para desarrolladores / curiosos técnicos. Si solo quieres desplegar, sigue los "Tres pasos" en el [README](../quick-start.md) principal.
...
├── quick-start.md                          # README principal (delgado)
└── LICENSE                            # MIT
```
