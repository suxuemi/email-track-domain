...
4. Seleccionar repositorio: `suxuemi/email-track-domain` (o tu fork)
5. Configuración:
...
Project Settings → Domains → Add Domain, seguir las instrucciones para añadir un CNAME. Ver [custom-domain.md](../custom-domain.md#deno-deploy).
