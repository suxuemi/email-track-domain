...
4. Sélectionnez le dépôt : `suxuemi/email-track-domain` (ou votre fork)
5. Configuration :
...
Project Settings → Domains → Add Domain, suivez les instructions pour ajouter un CNAME. Voir [custom-domain.md](../custom-domain.md#deno-deploy).
