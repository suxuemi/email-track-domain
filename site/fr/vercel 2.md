...
Voir le bouton à la racine du dépôt [quick-start.md](../quick-start.md).
...
Après le déploiement, allez dans Vercel Dashboard → Project → Settings → Domains, ajoutez votre domaine et suivez les instructions pour ajouter un CNAME `track → cname.vercel-dns.com` chez votre fournisseur DNS. Voir [custom-domain.md](../custom-domain.md).
