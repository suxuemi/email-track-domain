...
4. リポジトリを選択:`suxuemi/email-track-domain`(または fork したリポジトリ)
5. 設定:
...
Project Settings → Domains → Add Domain で CNAME を追加。詳細は [custom-domain.md](../custom-domain.md#deno-deploy)。
