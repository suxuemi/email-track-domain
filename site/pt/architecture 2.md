...
> Este documento é para desenvolvedores / curiosos técnicos. Se você só quer implantar, siga os "Três passos" no [README](../quick-start.md) principal.
...
├── quick-start.md                          # README principal (enxuto)
└── LICENSE                            # MIT
```
