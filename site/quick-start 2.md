...
| **Deno Deploy** | [→ 部署指南](deno-deploy.md) | 喜欢 Deno 生态 |
...
→ **[绑定自定义域名详细步骤](custom-domain.md)**（覆盖四个平台）
...
四层过滤逻辑、反 Microsoft Defender SafeLinks 扫描原理、IP 段更新流程、本地开发、源码结构等 → **[`architecture.md`](architecture.md)**
