...
按钮见仓库根目录 [quick-start.md](../quick-start.md)。
...
部署后在 Vercel Dashboard → Project → Settings → Domains 添加你的域名，按提示在 DNS 服务商配 CNAME `track → cname.vercel-dns.com`。详见 [custom-domain.md](../custom-domain.md)。
