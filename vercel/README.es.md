...
Botón en la raíz del repositorio [README.es.md](../README.es.md).
...
Tras el despliegue, ir a Vercel Dashboard → Project → Settings → Domains, añadir tu dominio y seguir las instrucciones para añadir un CNAME `track → cname.vercel-dns.com` en tu proveedor DNS. Detalles en [docs/custom-domain.es.md](../docs/custom-domain.es.md).
