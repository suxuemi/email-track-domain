...
部署後在 Vercel Dashboard → Project → Settings → Domains 加入你的網域,按提示在 DNS 服務商配 CNAME `track → cname.vercel-dns.com`。詳見 [docs/custom-domain.zh-TW.md](../docs/custom-domain.zh-TW.md)。
